...
class EmailSender:
    ...
    def send_email_to_student(self, recepient_email, message):
        try:
            ...
            self.msg['From'] = self.configuration['SENDER_EMAIL'].strip()
            ...
            print("sender password=",self.configuration['PASSWORD'].strip())
            self.smtp.login(self.msg['From'], self.configuration['PASSWORD'].strip())
